...
public class orderPage {
    ...
    //Поле ввода Адреса
    private By adresInput = By.xpath(".//input[@placeholder='* Адрес: куда привезти заказ']");
    ...
    public void setAdres(String adres) {
        driver.findElement(adresInput).clear();
    ...
    public void order (String name, String family, String adres, int metroPoint, String number, String data, String period) {
        setName(name);
        setFamily(family);
        setAdres(adres);
